...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "relative rounded-xl border border-border/85 bg-card/82 text-card-foreground shadow-[0_1px_0_0_rgba(255,255,255,0.04)_inset,0_12px_32px_-20px_rgba(0,0,0,0.45)] backdrop-blur-sm",
        className
      )}
      {...props}
    />

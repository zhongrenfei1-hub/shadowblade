...
export type Asset = {
  id: number;
  name: string;
  kind: "video" | "image" | "audio" | "font" | "logo";
  slug: string;
  size_bytes: number;
  tags: string[];
  created_at: string;
...
const ASSET_FALLBACK: Asset[] = [
  { id: 1, name: "品牌 logo · 主色", kind: "logo", slug: "logo-primary", size_bytes: 48212, tags: ["品牌", "已审核"], created_at: new Date().toISOString() },
  { id: 2, name: "品牌 logo · 单色", kind: "logo", slug: "logo-mono", size_bytes: 41900, tags: ["品牌", "已审核"], created_at: new Date().toISOString() },
  ...
  { id: 5, name: "产品 UI · 工作台", kind: "image", slug: "ui-dashboard", size_bytes: 612440, tags: ["资源库"], created_at: new Date().toISOString() },
  { id: 6, name: "产品 UI · 编辑器", kind: "image", slug: "ui-studio", size_bytes: 588212, tags: ["资源库"], created_at: new Date().toISOString() },
...
const TEMPLATE_FALLBACK: Template[] = [
  { id: 1, slug: "hero-launch", name: "发布主推 · 30 秒", category: "marketing", aspect_ratio: "9:16", duration_seconds: 30, scenes: 5 },
  { id: 2, slug: "product-explainer", name: "产品讲解 · 60 秒", category: "product_demo", aspect_ratio: "16:9", duration_seconds: 60, scenes: 6 },
  { id: 3, slug: "training-module", name: "培训模块 · 3 分钟", category: "training", aspect_ratio: "16:9", duration_seconds: 180, scenes: 4 },
